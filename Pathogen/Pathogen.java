...
public class Pathogen
{
	...
	// Takes a 2D char maze and returns a HashSet of the correct paths in
	// a string format
	...
	{
		// Included when we hit a "coronavirus" which is an invalid space
	...
	// Stringbuilder function that adds correct moves to the current string and returns that string
	public static String fasterConcatenation(String s, int i)
	{
		StringBuilder builder = new StringBuilder(s.length());
		// Add l when move is left
		if (i == 0)
			builder.append(s).append('l').append(" ");

		// Add r when move is right
		if (i == 1)
			builder.append(s).append('r').append(" ");

		// Add u when move is up
	 	if (i == 2)
			builder.append(s).append('u').append(" ");

		// Add d when move is down
	 	if (i == 3)
