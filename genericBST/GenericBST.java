...
public class BST
{
	...
	private Node insert(Node root, <anything> data)
	{
		if (root == null)
		{
	...
	public void delete(<anything> data)
	{
		root = delete(root, data);
	}

	private Node delete(Node root, <anything> data)
	{
		if (root == null)
		{
			return null;
	...
	private <anything> findMax(Node root)
	{
	...
	public boolean contains(<anything> data)
	{
		return contains(root, data);
	}

	private boolean contains(Node root, <anything> data)
	{
		if (root == null)
		{
			return false;
